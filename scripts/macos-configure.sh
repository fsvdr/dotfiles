...
: '
  Configures the macOS defaults preferences

  Heavily based on Mathias Bynen s dotfiles
  https://mths.be/macos
'
macos-configure() {
  ...
  defaults write com.apple.finder NewWindowTargetPath -string "file://${HOME}/Desktop/Screenshots"
